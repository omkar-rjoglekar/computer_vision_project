...
def main():
    ...
    total_real = len(fakes_dataset_train.real_image_names)
    total_fake = len(fakes_dataset_train.fake_image_names)
    ...
    real_image_idx = random.choice(range(total_real))
    fake_image_idx = random.choice(range(total_real, len(fakes_dataset_train)))
    ...
    total_real_2 = len(synthetic_dataset_train.real_image_names)
    total_fake_2 = len(synthetic_dataset_train.fake_image_names)
    ...
    real_image_idx = random.choice(range(total_real_2))
    fake_image_idx = random.choice(range(total_real_2, len(synthetic_dataset_train)))
    plt.subplot(2, 2, 3)
    plt.imshow(normalize(
